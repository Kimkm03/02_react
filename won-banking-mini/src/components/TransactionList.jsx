...
function TransactionList({ transactions, showAmount }) {
  // data 변수에 전체 return 받음
  // const { data, loading, error, reload } = useFetch(fetchTransactions); // 콜백 함수
  ...
  return (
    <>
      ...
      <div className="summary">
        총 {visibleTransactions.length}건 · 합계 {formatWonMasked(totalAmount, !showAmount)}
      </div>
